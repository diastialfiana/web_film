            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        @auth
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('movies.index') }}">{{ __('app.nav.movies') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('favorites.index') }}">{{ __('app.nav.favorites') }}</a>
                            </li>
                        @endauth
                    </ul>
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownLang" style="background-color: #1a1a1a; border: 1px solid #333;">
                                <a class="dropdown-item text-white hover-bg-danger" href="{{ route('language.switch', 'en') }}">EN</a>
                                <a class="dropdown-item text-white hover-bg-danger" href="{{ route('language.switch', 'id') }}">ID</a>
                            </div>
                        </li>
                        @guest
                            <li class="nav-item">
