            ...
            <div class="col-md-5">
                <div class="glass-card p-5">
                    <div class="text-center mb-5">
                        <h2 class="login-header text-white mb-2"><?php echo e(__('app.auth.login')); ?></h2>
                        <p class="text-muted"><?php echo e(__('app.auth.welcome')); ?></p>
                    </div>
                    ...
                    <form method="POST" action="<?php echo e(route('login')); ?>">
                        ...
                        <div class="form-group mb-4">
                            <label class="text-white small font-weight-bold mb-2"><?php echo e(__('app.auth.username')); ?></label>
                            <input type="text" class="form-control <?php if ($errors->has('username')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('username'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="username" value="<?php echo e(old('username')); ?>" required autofocus placeholder="aldmic">
                        </div>

                        <div class="form-group mb-5">
                            <label class="text-white small font-weight-bold mb-2"><?php echo e(__('app.auth.password')); ?></label>
                            <input type="password" class="form-control <?php if ($errors->has('password')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('password'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="password" required placeholder="••••••••">
                        </div>
                        ...
                        <div class="text-center">
                            <small class="text-muted"><?php echo e(__('app.auth.testing_account')); ?>: <strong>aldmic / 123abc123</strong></small>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TechnicalTest\resources\views/auth/login.blade.php ENDPATH**/ ?>